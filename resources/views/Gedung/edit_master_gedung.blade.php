      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        @csrf
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Tipe Pemilik"  name="tipe_pemilik" value="{{ $edit->tipe_pemilik }}" required>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Kompleksitas"  name="kompleks" value="{{ $edit->kompleks }}" required>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Tingkat Resiko Kebakaran"  name="rsk_kebakaran" value="{{ $edit->tkt_resiko_kebakaran }}" required>
          </div>

          <div class="form-group">
            <label>Penangkal Petir:</label>
            <input type="text" class="form-control" placeholder="Penangkal Petir"  name="penangkal_petir" value="{{ $edit->penangkal_petir }}" required>
          </div>
          ...
          <div class="form-group">
            <label>KDB:</label>
            <input type="text" class="form-control" placeholder="KDB" value="{{ $edit->kdb }}"  name="kdb" required>
          </div>

          <div class="form-group">
            <label>KLB:</label>
            <input type="text" class="form-control" placeholder="KLB" value="{{ $edit->klb }}"  name="klb" required>
          </div>

          <div class="form-group">
            <label>KDH:</label>
            <input type="text" class="form-control" placeholder="KDH" value="{{ $edit->kdh }}" name="kdh" required>
          </div>

          <div class="form-group">
            <label>GSB:</label>
            <input type="text" class="form-control" placeholder="GSB" value="{{ $edit->gsb }}" name="gsb" required>
          </div>

          <div class="form-group">
            <label>RTH:</label>
            <input type="text" class="form-control" placeholder="RTH" value="{{ $edit->rth }}" name="rth" required>
          </div>
